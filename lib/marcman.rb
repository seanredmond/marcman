...
module Marcman
 ...
 "306"=>
  {:definition=>"Playing Time",
   :repeat=>false,
   :indicators=>[:undefined, :undefined],
   :subfields=>{"$a"=>{:definition=>"Playing time", :repeat=>true}},
   :group=>"3XX"},
 "307"=>
  ...
  {:definition=>"Geospatial Reference Data",
   ...
   :subfields=>{
     ...
     "$e"=>{:definition=>"Standard parallel or oblique line latitude",
            :repeat=>true},
     "$f"=>{:definition=>"Oblique line longitude", :repeat=>true},
 ...
 "351"=>
  {:definition=>"Organization and Arrangement of Materials",
   ...
   :indicators=>[:undefined, :undefined],
   :subfields=>{
     "$a"=>{:definition=>"Organization", :repeat=>true},
     "$b"=>{:definition=>"Arrangement", :repeat=>true},
 ...
 "352"=>
  {:definition=>"Digital Graphic Representation",
   ...
   :subfields=>{
     ...
     "$b"=>{:definition=>"Object type", :repeat=>true},
     "$c"=>{:definition=>"Object count", :repeat=>true},
 ...
 "355"=>
  {:definition=>"Security Classification Control",
   ...
   :subfields=>{
     ...
     "$b"=>{:definition=>"Handling instructions", :repeat=>true},
     "$c"=>{:definition=>"External dissemination information", :repeat=>true},
     ...
     "$j"=>{:definition=>"Authorization", :repeat=>true}},
   :group=>"3XX"},
 "357"=>
  {:definition=>"Originator Dissemination Control",
   ...
   :subfields=>{
     ...
     "$b"=>{:definition=>"Originating agency", :repeat=>true},
     "$c"=>{:definition=>"Authorized recipients of material", :repeat=>true},
     "$g"=>{:definition=>"Other restrictions", :repeat=>true}},
   :group=>"3XX"},
 "362"=>
